...
M_SIGNON
		.BYTE	$0D,$0A
		.BYTE	"Baffa-2 Homebrew Microcomputer"
		.BYTE	$0D,$0A
		.BYTE	"CP/M Boot ROM 2.0"
		.BYTE	" by G. Searle"
		.BYTE	$0D,$0A
		.BYTE	$0D,$0A
...
WRKSPC  .EQU    9090H             ; BASIC Work space
